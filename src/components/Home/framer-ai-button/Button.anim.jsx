// No need to import 'Variants' from 'framer-motion' in plain JavaScript
...
export const buttonAnim = {
  ...
  anim: {
    scale: 2,
    boxShadow:
      "0 0 20rem 10rem rgba(65, 18, 161, 0.7), 0 2px 0 0 rgb(120, 54, 250) inset, 0 -2px 0 0 rgb(86, 4, 250) inset",

  ...
  return (
    <div className="mt-24">
      ...
      <div className="p-4">
        <div className="mb-32">
          <m.div
            className="lg:mx-24 flex flex-col lg:flex-row justify-evenly items-center"
            initial="offscreen"
            ...
            <m.div className="lg:w-[35%]" variants={animation2}>
              <div>
                ...
                <p className=" text-lg leading-[1.9rem] text-gray-200 tracking-wider">
                  Bharattech is revolutionizing India's technology ecosystem
                  with innovative AI, data accessibility, and advanced computing
                  products. Emphasizing privacy, efficiency, and sustainability,
                  Bharattech supports startups through its Startup Support
                  Program, fostering innovation and shaping India's
        ...
        <div className="mb-32">
          <m.div
            className=" lg:mx-24 flex flex-col lg:flex-row-reverse justify-evenly items-center"
            initial="offscreen"
            whileInView="onscreen"
            viewport={{ once: true, amount: 0.3 }}
          >
            <m.div className="lg:w-[35%]" variants={animation}>
              <div>
                ...
                <p className=" text-lg leading-[1.9rem] text-gray-200 tracking-wider">
                  ...
                  BharatAI, Recag, Collegecue, and Bsearch. These products
                  address high computing resource costs, provide education and
                  skill-building opportunities, and offer AI-enabled hyper-local
                  search capabilities. They aim to make technology more
                  inclusive, affordable, and efficient while maintaining privacy
                  and security.
                </p>
              </div>
            </m.div>

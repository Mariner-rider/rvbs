const TextRevealButton = () => {
  return (
    // <button className="group/button relative inline-flex h-12 w-12 items-center justify-center overflow-hidden rounded-full bg-red-500 font-medium text-white transition-all duration-300 hover:w-24">
    ...
    //   </div>
    // </button>
    <button className="group/button relative overflow-hidden rounded-md border border-red-500/20 bg-orange-500 px-4 py-1 text-lg font-medium text-indigo-500 transition-all duration-150 hover:border-indigo-500 active:scale-95">

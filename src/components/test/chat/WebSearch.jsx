...
//           {/* Logo/Brand */}
//           <div className="mb-12">
//             <h1 className={`text-7xl font-bold mb-4 bg-gradient-to-r from-purple-600 via-blue-500 to-indigo-600 bg-clip-text text-transparent ${
//               isDark ? 'opacity-90' : ''
//             }`}>
//               BharatAi
//             </h1>
...
//             <div className={`relative flex items-center rounded-full shadow-xl border-2 ${
//               isDark 
...
//                 className={`flex-1 px-6 py-4 text-lg rounded-full bg-transparent outline-none ${
...
//                 className={`p-3 mx-2 rounded-full transition-all duration-200 ${
//                   isListening
...
//                 className={`p-3 mr-2 rounded-full transition-all duration-200 ${
//                   searchQuery.trim()
